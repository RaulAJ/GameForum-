...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-05-2024 a las 19:10:15
...
(2, 'Como un portalaa', 'dacendej', 'Minecraft', 'Guia', '2010-03-24', 'Primero noooo has de hacerte con un pico de diamante para poder picar 10 bloques de obsidiana, luego tienes que ponerlos en forma de portal y prender la parte inferior con un mechero. Listo! Si el portal se ha puesto en morado, cruzalo y estaras en el nether.'),
...
(6, 'q', 'dacendej', 'Minecraft', 'aa', '1111-11-11', 'aaaaaa'),
(7, 'aaaaaaaaaaaaaaa', 'dacendej', 'Minecraft', 'duda', '1010-10-10', 'aaaaaaaaaaaaaa'),
(8, 'aaaaaaaaab', 'dacendej', 'Minecraft', 'guia', '1111-11-11', 'aaaaaaaaaaaa'),
(9, '11111111111112', 'dacendej', 'The Legend of Zelda:', 'Guía', '2222-02-22', 'a');
...
CREATE TABLE `usuarios` (
  ...
  `JuegosValorados` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

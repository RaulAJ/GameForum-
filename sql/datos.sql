...
(9, 'The Last of Us: Part III', 2023, 'Naughty Dog', 'Aventura', 0, 7, 'The Last of Us: Part III es la continuación de la aclamada serie de juegos de aventuras postapocalípticas. Ambientado en un mundo devastado por una plaga, los jugadores seguirán a Ellie en su viaje para encontrar esperanza en un mundo desesperado.'),
